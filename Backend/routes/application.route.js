...
import { applyJob, getApplicants, getAppliedJobs, updateStatus, cancelApplication } from "../controllers/application.controller.js";
...
router.route("/cancel/:id").delete(authenticateToken, cancelApplication);
